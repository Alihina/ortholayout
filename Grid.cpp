...
void Grid::deconstruct()
{
	clear();
	m_Grid.init();
	//Verschiebung des Koordinatenursprungs in den Mittelpunkt
	//m_pos wird um -v verschoben und 
	//alles andere um v
	//Dabei verschiebt v alles so, dass der linke obere Eckpunkt anschließend Mittelpunkt ist 
	//aber m_pos muss um -v verschoben werden, weil wir nur Koordinatentransformation vornehmen wollen. 
	//IPoint MPoint=gebBox
	//Mittelpunkt finden
	//Alles um Mittelpunkt verschieben
}
